...
var _user$project$Model_Card$encodeCard = function (_p0) {
	var _p1 = _p0;
	var suitVal = _elm_lang$core$String$toLower(
		_elm_lang$core$Basics$toString(_p1._1));
	var rankVal = _elm_lang$core$String$toLower(
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'rank',
				_1: _elm_lang$core$Json_Encode$string(rankVal)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'suit',
					_1: _elm_lang$core$Json_Encode$string(suitVal)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Model_Card$King = {ctor: 'King'};
var _user$project$Model_Card$Queen = {ctor: 'Queen'};
var _user$project$Model_Card$Jack = {ctor: 'Jack'};
var _user$project$Model_Card$Ten = {ctor: 'Ten'};
var _user$project$Model_Card$Nine = {ctor: 'Nine'};
var _user$project$Model_Card$Ace = {ctor: 'Ace'};
var _user$project$Model_Card$rankDecoder = function (rank) {
	var _p2 = rank;
	switch (_p2) {
		case 'ace':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Ace);
		case 'nine':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Nine);
		case 'ten':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Ten);
		case 'jack':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Jack);
		case 'queen':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Queen);
		case 'king':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$King);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'invalid rank: ', rank));
	}
};
var _user$project$Model_Card$Spades = {ctor: 'Spades'};
var _user$project$Model_Card$Hearts = {ctor: 'Hearts'};
var _user$project$Model_Card$Diamonds = {ctor: 'Diamonds'};
var _user$project$Model_Card$Clubs = {ctor: 'Clubs'};
var _user$project$Model_Card$suitDecoder = function (suit) {
	var _p3 = suit;
	switch (_p3) {
		case 'clubs':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Clubs);
		case 'diamonds':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Diamonds);
		case 'hearts':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Hearts);
		case 'spades':
			return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Card$Spades);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'invalid suit: ', suit));
	}
};
var _user$project$Model_Card$cardDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A2(
		_elm_lang$core$Json_Decode$andThen,
		_user$project$Model_Card$rankDecoder,
		A2(_elm_lang$core$Json_Decode$field, 'rank', _elm_lang$core$Json_Decode$string)),
	A2(
		_elm_lang$core$Json_Decode$andThen,
		_user$project$Model_Card$suitDecoder,
		A2(_elm_lang$core$Json_Decode$field, 'suit', _elm_lang$core$Json_Decode$string)));

var _user$project$Model_Player$Player = F4(
	function (a, b, c, d) {
		return {bid: a, name: b, hand: c, score: d};
	});
var _user$project$Model_Player$playerDecoder = A3(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'hand',
		_elm_lang$core$Json_Decode$list(_user$project$Model_Card$cardDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_Player$Player)))));

var _user$project$Model_PlayerAction$encodePlayerActionValue = function (action) {
	var _p0 = action;
	if (_p0.ctor === 'Bid') {
		if (_p0._0.ctor === 'Healthy') {
			return _elm_lang$core$Json_Encode$string('healthy');
		} else {
			return _elm_lang$core$Json_Encode$string('marriage');
		}
	} else {
		return _user$project$Model_Card$encodeCard(_p0._0);
	}
};
var _user$project$Model_PlayerAction$encodePlayerActionType = function (action) {
	var _p1 = action;
	if (_p1.ctor === 'Bid') {
		return 'bid';
	} else {
...
var _user$project$Model_PlayerAction$encodePlayerAction = function (action) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Model_PlayerAction$encodePlayerActionType(action),
		_1: _user$project$Model_PlayerAction$encodePlayerActionValue(action)
	};
};
var _user$project$Model_PlayerAction$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Model_PlayerAction$Bid = function (a) {
	return {ctor: 'Bid', _0: a};
};
var _user$project$Model_PlayerAction$Marriage = {ctor: 'Marriage'};
var _user$project$Model_PlayerAction$Healthy = {ctor: 'Healthy'};

var _user$project$Model_Status$Decided = {ctor: 'Decided'};
var _user$project$Model_Status$AwaitingAction = function (a) {
	return {ctor: 'AwaitingAction', _0: a};
};
var _user$project$Model_Status$AwaitingBids = {ctor: 'AwaitingBids'};
var _user$project$Model_Status$AwaitingPlayers = {ctor: 'AwaitingPlayers'};
var _user$project$Model_Status$statusTupleDecoder = function (status) {
	var _p0 = status;
	_v0_4:
	do {
		if (_p0._1.ctor === 'Just') {
			if (_p0._0 === 'awaiting_action') {
				return _elm_lang$core$Json_Decode$succeed(
					_user$project$Model_Status$AwaitingAction(_p0._1._0));
			} else {
				break _v0_4;
			}
		} else {
			switch (_p0._0) {
				case 'awaiting_players':
					return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Status$AwaitingPlayers);
				case 'awaiting_bids':
					return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Status$AwaitingBids);
				case 'decided':
					return _elm_lang$core$Json_Decode$succeed(_user$project$Model_Status$Decided);
				default:
					break _v0_4;
			}
		}
	...
	return _elm_lang$core$Json_Decode$fail(
		A2(_elm_lang$core$Basics_ops['++'], 'invalid status: ', _p0._0));
};
var _user$project$Model_Status$statusDecoder = function () {
	var toTuple = A3(
		_elm_lang$core$Json_Decode$map2,
		F2(
			function (v0, v1) {
		...
		A2(
			...
			'value',
			_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$string)));
	return A2(_elm_lang$core$Json_Decode$andThen, _user$project$Model_Status$statusTupleDecoder, toTuple);
}();
var _user$project$Model_Status$AwaitingServer = {ctor: 'AwaitingServer'};

var _user$project$Model_Trick$tuple4 = F4(
	function (a, b, c, d) {
		return {ctor: '_Tuple4', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Model_Trick$tuple3 = F3(
	function (a, b, c) {
		return {ctor: '_Tuple3', _0: a, _1: b, _2: c};
	});
var _user$project$Model_Trick$trickPartDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'card', _user$project$Model_Card$cardDecoder));
var _user$project$Model_Trick$completeTrickDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Model_Trick$tuple4,
	A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Model_Trick$trickPartDecoder),
	A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Model_Trick$trickPartDecoder),
	A2(_elm_lang$core$Json_Decode$index, 2, _user$project$Model_Trick$trickPartDecoder),
	A2(_elm_lang$core$Json_Decode$index, 3, _user$project$Model_Trick$trickPartDecoder));
var _user$project$Model_Trick$scoredTrickDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Model_Trick$tuple3,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'score', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'trick', _user$project$Model_Trick$completeTrickDecoder));
var _user$project$Model_Trick$incompleteTrickDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Model_Trick$tuple4,
...
var _user$project$Model_GameState$tuple4 = F4(
	function (a, b, c, d) {
		return {ctor: '_Tuple4', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Model_GameState$gameIdDecoder = _elm_lang$core$Json_Decode$int;
var _user$project$Model_GameState$playerTupleDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Model_GameState$tuple4,
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$index, 0, _user$project$Model_Player$playerDecoder)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$index, 1, _user$project$Model_Player$playerDecoder)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$index, 2, _user$project$Model_Player$playerDecoder)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$index, 3, _user$project$Model_Player$playerDecoder)));
var _user$project$Model_GameState$availableActions = F2(
		...
		switch (_p0.ctor) {
			case 'AwaitingBids':
				...
				if (_p1.ctor === 'Just') {
					...
					return {
						ctor: '::',
						_0: _user$project$Model_PlayerAction$Bid(_user$project$Model_PlayerAction$Healthy),
						_1: {
							ctor: '::',
							_0: _user$project$Model_PlayerAction$Bid(_user$project$Model_PlayerAction$Marriage),
							_1: {ctor: '[]'}
						}
					};
				}
			case 'AwaitingAction':
				return _elm_lang$core$Native_Utils.eq(_p0._0, player.name) ? A2(_elm_lang$core$List$map, _user$project$Model_PlayerAction$Play, player.hand) : {ctor: '[]'};
			default:
				return {ctor: '[]'};
		}
	});
var _user$project$Model_GameState$GameState = F6(
	function (a, b, c, d, e, f) {
		return {id: a, deck: b, players: c, currentTrick: d, scoredTricks: e, status: f};
	});
var _user$project$Model_GameState$gameStateDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'status',
	_user$project$Model_Status$statusDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'scored_tricks',
		_elm_lang$core$Json_Decode$list(_user$project$Model_Trick$scoredTrickDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'current_trick',
			_user$project$Model_Trick$incompleteTrickDecoder,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'players',
				_user$project$Model_GameState$playerTupleDecoder,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'deck',
					_elm_lang$core$Json_Decode$list(_user$project$Model_Card$cardDecoder),
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'id',
						_user$project$Model_GameState$gameIdDecoder,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model_GameState$GameState)))))));

var _user$project$Channel$pushGameAction = F3(
	function (gameId, action, onError) {
		var topic = A2(
			_elm_lang$core$Basics_ops['++'],
			'game:',
			_elm_lang$core$Basics$toString(gameId));
		var _p0 = _user$project$Model_PlayerAction$encodePlayerAction(action);
		var actionType = _p0._0;
		var actionValue = _p0._1;
		var payload = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'value', _1: actionValue},
				_1: {ctor: '[]'}
			});
		var event = A2(_elm_lang$core$Basics_ops['++'], 'action:', actionType);
		return A2(
			...
			A2(
				...
				payload,
				A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, event, topic)));
	});
var _user$project$Channel$userParams = function (username) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Channel$join = function (_p1) {
	var _p2 = _p1;
	return A2(
		...
		A2(
			...
			A2(
				...
				_user$project$Channel$userParams(_p2.username),
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$init(_p2.topic))));
};
var _user$project$Channel$ChannelJoinOptions = F4(
	function (a, b, c, d) {
		return {onJoin: a, onJoinError: b, username: c, topic: d};
	});

var _user$project$Model$initSocket = _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
...
var _user$project$Model$init = {
	...
	_0: {
		...
		socket: _user$project$Model$initSocket,
		username: '',
		registered: false,
		tab: 0,
		errors: {ctor: '[]'}
...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {socket: a, gameState: b, username: c, registered: d, tab: e, errors: f};
	});
var _user$project$Model$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _user$project$Model$ExpireErrors = {ctor: 'ExpireErrors'};
var _user$project$Model$ShowError = function (a) {
	return {ctor: 'ShowError', _0: a};
};
var _user$project$Model$Action = function (a) {
	return {ctor: 'Action', _0: a};
};
var _user$project$Model$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$Model$JoinGame = function (a) {
	return {ctor: 'JoinGame', _0: a};
};
var _user$project$Model$LeaveLobby = function (a) {
	return {ctor: 'LeaveLobby', _0: a};
};
var _user$project$Model$JoinLobby = {ctor: 'JoinLobby'};
var _user$project$Model$NewGameState = function (a) {
	return {ctor: 'NewGameState', _0: a};
};
var _user$project$Model$SocketMessage = function (a) {
	return {ctor: 'SocketMessage', _0: a};
};

var _user$project$View_Card$cardBaseView = F3(
	function (wrapperAttrs, imgAttrs, card) {
		return A2(
...
var _user$project$View_Card$cardFrontView = F2(
	function (attrs, card) {
		var _p0 = card;
		var rank = _p0._0;
		var suit = _p0._1;
		var imgSrc = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(rank),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'_of_',
					A2(
						...
						'.png'))));
		return A3(
			_user$project$View_Card$cardBaseView,
			attrs,
			{
				ctor: '::',
...
var _user$project$View_Card$cardBackView = function (attrs) {
	return A2(
		_user$project$View_Card$cardBaseView,
		attrs,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$src('/cards/back.png'),
			_1: {ctor: '[]'}
		});
};

var _user$project$View_Hand$handContainer = _elm_lang$html$Html$div(
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('hand'),
		_1: {ctor: '[]'}
	});
var _user$project$View_Hand$concealedHandView = function (hand) {
	return _user$project$View_Hand$handContainer(
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Card$cardBackView(
				{ctor: '[]'}),
			hand));
};
var _user$project$View_Hand$visibleHandView = function (hand) {
	return _user$project$View_Hand$handContainer(
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Card$cardFrontView(
				{ctor: '[]'}),
			hand));
};
var _user$project$View_Hand$activeHandView = F2(
	function (onSelect, hand) {
		return _user$project$View_Hand$handContainer(
			A2(
				_elm_lang$core$List$map,
				function (c) {
					return A2(
						_user$project$View_Card$cardFrontView,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('selectable'),
								_1: {ctor: '[]'}
							}
						},
						c);
...
var _user$project$View_Trick$scoredTrickView = function (_p0) {
	var _p1 = _p0;
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View_Hand$visibleHandView(
								{
									ctor: '::',
									_0: _p1._2._0._1,
									_1: {
...
var _user$project$View_Trick$scoredTricksView = function (tricks) {
	return A2(
		...
		},
		{
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Trick'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$View_Trick$scoredTrickView, tricks)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View_Trick$currentTrickView = function (_p2) {
	var _p3 = _p2;
	var maybeCardView = function (card) {
		var _p4 = card;
		if (_p4.ctor === 'Just') {
			return A2(
				_user$project$View_Card$cardFrontView,
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('trick'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: maybeCardView(
				A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p3._3)),
			_1: {
				ctor: '::',
				_0: maybeCardView(
					A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p3._2)),
				_1: {
					ctor: '::',
					_0: maybeCardView(
						A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p3._1)),
					_1: {
						ctor: '::',
						_0: maybeCardView(
							A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p3._0)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View_UI$toast = function (attrs) {
...
var _user$project$View_UI$errorToast = function (attrs) {
	return _user$project$View_UI$toast(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('toast-error'),
			_1: attrs
		});
};
var _user$project$View_UI$tabs = F2(
	function (_p0, labels) {
		var _p1 = _p0;
		var tab = F2(
							...
							_0: _elm_lang$html$Html_Attributes$classList(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'active',
										_1: _elm_lang$core$Native_Utils.eq(index, _p1.selectedIndex)
									},
									_1: {ctor: '[]'}
								}),
							_1: {
		...
		return A2(
			...
			A2(_elm_lang$core$List$indexedMap, tab, labels));
	});
var _user$project$View_UI$column = function (_p2) {
	var _p3 = _p2;
	var alignClass = function () {
		var _p4 = _p3.align;
		switch (_p4.ctor) {
			case 'Center':
				return 'col-mx-auto';
	...
	var sizeClass = A2(
		_elm_lang$core$Basics_ops['++'],
		'col-',
		_elm_lang$core$Basics$toString(_p3.size));
	var classStr = A2(
		_elm_lang$core$String$join,
		' ',
		{
	...
	return _elm_lang$html$Html$div(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(classStr),
			_1: {ctor: '[]'}
		});
};
var _user$project$View_UI$grid = F2(
	function (attrs, columns) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _user$project$View_UI$ColumnOptions = F2(
	function (a, b) {
		return {size: a, align: b};
	});
var _user$project$View_UI$TabOptions = F2(
	function (a, b) {
		return {selectedIndex: a, onSelect: b};
	});
var _user$project$View_UI$None = {ctor: 'None'};
var _user$project$View_UI$Right = {ctor: 'Right'};
var _user$project$View_UI$Left = {ctor: 'Left'};
var _user$project$View_UI$Center = {ctor: 'Center'};

var _user$project$View_Game$hasName = F2(
	function (maybePlayer, name) {
		var _p0 = maybePlayer;
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p0._0.name, name);
		} else {
			return false;
		}
	});
var _user$project$View_Game$arrangePlayers = F2(
	function (_p1, username) {
		var _p2 = _p1;
		var _p6 = _p2._3;
		var _p5 = _p2._2;
		var _p4 = _p2._1;
		var _p3 = _p2._0;
		return A2(_user$project$View_Game$hasName, _p3, username) ? {
			ctor: '_Tuple2',
			_0: _p3,
			_1: {ctor: '_Tuple4', _0: _p4, _1: _p5, _2: _p6, _3: _p3}
		} : (A2(_user$project$View_Game$hasName, _p4, username) ? {
			ctor: '_Tuple2',
			_0: _p4,
			_1: {ctor: '_Tuple4', _0: _p5, _1: _p6, _2: _p3, _3: _p4}
		} : (A2(_user$project$View_Game$hasName, _p5, username) ? {
			ctor: '_Tuple2',
			_0: _p5,
			_1: {ctor: '_Tuple4', _0: _p6, _1: _p3, _2: _p4, _3: _p5}
		} : {
			ctor: '_Tuple2',
			_0: _p6,
			_1: {ctor: '_Tuple4', _0: _p3, _1: _p4, _2: _p5, _3: _p6}
		}));
	});
var _user$project$View_Game$actionView = function (action) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$a,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Model$Action(action)),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$View_Game$actionsView = F2(
	function (player, status) {
		var divider = A2(
			_elm_lang$html$Html$li,
			{
		...
		var header = A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('tile tile-centered'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
		...
		var actions = function () {
			var _p7 = player;
			if (_p7.ctor === 'Just') {
				return A2(_user$project$Model_GameState$availableActions, _p7._0, status);
			} else {
				return {ctor: '[]'};
			}
		}();
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('actions menu'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: divider,
					_1: A2(_elm_lang$core$List$map, _user$project$View_Game$actionView, actions)
				}
			});
	});
var _user$project$View_Game$playerView = F2(
	function (player, active) {
		var _p8 = function () {
			var _p9 = player;
			if (_p9.ctor === 'Just') {
				return {ctor: '_Tuple3', _0: _p9._0.hand, _1: _p9._0.name, _2: _p9._0.score};
			} else {
				return {
					ctor: '_Tuple3',
					_0: {ctor: '[]'},
		...
		var label = A2(
			...
			A2(
				...
				A2(
					...
					')')));
		var handView = active ? _user$project$View_Hand$activeHandView(
			function (c) {
				return _user$project$Model$Action(
					_user$project$Model_PlayerAction$Play(c));
			}) : _user$project$View_Hand$concealedHandView;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _user$project$View_Game$cardTableView = F2(
	function (_p10, centerpiece) {
		var _p11 = _p10;
		var bottomSeat = A2(_user$project$View_Game$playerView, _p11._3, true);
		var rightSeat = A2(_user$project$View_Game$playerView, _p11._2, false);
		var leftSeat = A2(_user$project$View_Game$playerView, _p11._0, false);
		var topSeat = A2(_user$project$View_Game$playerView, _p11._1, false);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('card-table'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('card-table-top'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('card-table-center'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('card-table-bottom'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$View_Game$deckView = function (deck) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$View_Game$gameView = F2(
	function (_p12, username) {
		var _p13 = _p12;
		var _p15 = _p13.deck;
		var centerpiece = _elm_lang$core$List$isEmpty(_p15) ? _user$project$View_Trick$currentTrickView(_p13.currentTrick) : _user$project$View_Game$deckView(_p15);
		var _p14 = A2(_user$project$View_Game$arrangePlayers, _p13.players, username);
		var currentPlayer = _p14._0;
		var arrangedPlayers = _p14._1;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			{
				ctor: '::',
				_0: A2(_user$project$View_Game$cardTableView, arrangedPlayers, centerpiece),
				_1: {
					ctor: '::',
					_0: A2(_user$project$View_Game$actionsView, currentPlayer, _p13.status),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View_Game$tabbedView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_user$project$View_UI$tabs,
				{selectedIndex: model.tab, onSelect: _user$project$Model$SelectTab},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Game'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Tricks'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				ctor: '::',
				_0: function () {
					var _p16 = {ctor: '_Tuple2', _0: model.gameState, _1: model.tab};
					_v6_2:
					do {
						if ((_p16.ctor === '_Tuple2') && (_p16._0.ctor === 'Just')) {
							switch (_p16._1) {
								case 0:
									return A2(_user$project$View_Game$gameView, _p16._0._0, model.username);
								case 1:
									return _user$project$View_Trick$scoredTricksView(_p16._0._0.scoredTricks);
								default:
									break _v6_2;
							}
						} else {
...
var _user$project$View_Lobby$submitBtn = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$JoinLobby),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('btn btn-primary input-group-btn'),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _user$project$View_Lobby$usernameField = function (username) {
	return A2(
		_elm_lang$html$Html$input,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$Model$SetUsername),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(username),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('Enter a username...'),
					_1: {
						ctor: '::',
...
var _user$project$View_Lobby$lobbyView = function (_p0) {
	var _p1 = _p0;
	return A2(
		_user$project$View_UI$grid,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_user$project$View_UI$column,
				{size: 6, align: _user$project$View_UI$Center},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Doppelkopf'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$View_Lobby$usernameField(_p1.username),
												_1: {
													ctor: '::',
													_0: _user$project$View_Lobby$submitBtn,
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
...
var _user$project$View$error = function (msg) {
	return A2(
		_user$project$View_UI$errorToast,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
...
var _user$project$View$errors = function (messages) {
	var _p0 = messages;
	if (_p0.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		return A2(_elm_lang$core$List$map, _user$project$View$error, _p0);
	}
};
var _user$project$View$view = function (model) {
	var _p1 = _elm_lang$core$List$unzip(model.errors);
	var errorMessages = _p1._0;
	var mainView = function () {
		var _p2 = model.gameState;
		if (_p2.ctor === 'Just') {
			return _user$project$View_Game$tabbedView(model);
		} else {
			return _user$project$View_Lobby$lobbyView(model);
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							_user$project$View_UI$column,
							{size: 8, align: _user$project$View_UI$Center},
							_user$project$View$errors(errorMessages)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$subscriptions = function (model) {
	var errorTimer = A2(
		...
		_elm_lang$core$Basics$always(_user$project$Model$ExpireErrors));
	var socketListener = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.socket, _user$project$Model$SocketMessage);
...
var _user$project$Main$onNewGameState = function (response) {
	var _p0 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Model_GameState$gameStateDecoder, response);
	if (_p0.ctor === 'Ok') {
		return _user$project$Model$NewGameState(_p0._0);
	} else {
		return _user$project$Model$ShowError(_p0._0);
	}
};
var _user$project$Main$onServerError = function (response) {
	var errorDecoder = A2(_elm_lang$core$Json_Decode$field, 'reason', _elm_lang$core$Json_Decode$string);
	var msg = function () {
		var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, errorDecoder, response);
		if (_p1.ctor === 'Ok') {
			return _p1._0;
		} else {
			return _p1._0;
	...
	return _user$project$Model$ShowError(msg);
};
var _user$project$Main$onJoinLobbyError = function (response) {
	var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, response);
	if (_p2.ctor === 'Ok') {
		return _user$project$Model$LeaveLobby(_p2._0);
	} else {
		return _user$project$Model$LeaveLobby(_p2._0);
	}
};
var _user$project$Main$onJoinLobby = function (response) {
	var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Model_GameState$gameIdDecoder, response);
	if (_p3.ctor === 'Ok') {
		return _user$project$Model$JoinGame(_p3._0);
	} else {
		return _user$project$Model$ShowError(_p3._0);
	}
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p4.ctor) {
				case 'SocketMessage':
					var _p5 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p4._0, model.socket);
					var socket = _p5._0;
					var cmd = _p5._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{socket: socket}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Model$SocketMessage, cmd)
					};
				case 'SetUsername':
					return {
						ctor: '_Tuple2',
				...
				case 'JoinLobby':
					var channel = _user$project$Channel$join(
						{onJoin: _user$project$Main$onJoinLobby, onJoinError: _user$project$Main$onServerError, username: model.username, topic: 'game:lobby'});
					var _p6 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, model.socket);
					var socket = _p6._0;
					var cmd = _p6._1;
					return {
						ctor: '_Tuple2',
				...
				case 'LeaveLobby':
					var errors = {
						...
						_0: {
							ctor: '_Tuple2',
							_0: _p4._0,
							_1: _elm_lang$core$Time$inSeconds(3)
						},
						_1: model.errors
					};
					var _p7 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$leave, 'game:lobby', model.socket);
					var socket = _p7._0;
					var cmd = _p7._1;
					return {
						ctor: '_Tuple2',
				...
				case 'JoinGame':
					...
					var channel = _user$project$Channel$join(
						{onJoin: _user$project$Main$onNewGameState, onJoinError: _user$project$Main$onServerError, username: model.username, topic: topic});
					var _p8 = A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Socket$join,
						channel,
						A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on, 'update', topic, _user$project$Main$onNewGameState, model.socket));
					var socket = _p8._0;
					var cmd = _p8._1;
					return {
						ctor: '_Tuple2',
				...
				case 'Action':
					...
					if (_p9.ctor === 'Just') {
						var _p10 = A2(
							...
							A3(_user$project$Channel$pushGameAction, _p9._0.id, _p4._0, _user$project$Main$onServerError),
							model.socket);
						var socket = _p10._0;
						var cmd = _p10._1;
						return {
						...
						var _v6 = _user$project$Model$ShowError('Action fired without an active game'),
							_v7 = model;
						msg = _v6;
						model = _v7;
						continue update;
				...
				case 'NewGameState':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								gameState: _elm_lang$core$Maybe$Just(_p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ShowError':
				...
				case 'ExpireErrors':
					var decrementOrExpire = function (_p11) {
						var _p12 = _p11;
						var _p13 = _p12._1;
						return (_elm_lang$core$Native_Utils.cmp(_p13, 0) > 0) ? _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p12._0, _1: _p13 - 1}) : _elm_lang$core$Maybe$Nothing;
					};
					var errors = A2(_elm_lang$core$List$filterMap, decrementOrExpire, model.errors);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{view: _user$project$View$view, init: _user$project$Model$init, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Model.PlayerAction.PlayerAction":{"args":[],"tags":{"Play":["Model.Card.Card"],"Bid":["Model.PlayerAction.BidValue"]}},"Model.Msg":{"args":[],"tags":{"SelectTab":["Int"],"NewGameState":["Model.GameState.GameState"],"ShowError":["String"],"Action":["Model.PlayerAction.PlayerAction"],"SetUsername":["String"],"JoinGame":["Int"],"ExpireErrors":[],"JoinLobby":[],"SocketMessage":["Phoenix.Socket.Msg Model.Msg"],"LeaveLobby":["String"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Model.PlayerAction.BidValue":{"args":[],"tags":{"Healthy":[],"Marriage":[]}},"Model.Status.Status":{"args":[],"tags":{"AwaitingAction":["Model.Player.PlayerName"],"AwaitingServer":[],"AwaitingPlayers":[],"Decided":[],"AwaitingBids":[]}},"Model.Card.Rank":{"args":[],"tags":{"Nine":[],"Ten":[],"Queen":[],"Jack":[],"Ace":[],"King":[]}},"Model.Card.Suit":{"args":[],"tags":{"Diamonds":[],"Clubs":[],"Hearts":[],"Spades":[]}},"Phoenix.Socket.Msg":{"args":["msg"],"tags":{"ChannelErrored":["String"],"ChannelClosed":["String"],"ExternalMsg":["msg"],"ChannelJoined":["String"],"Heartbeat":["Time.Time"],"NoOp":[],"ReceiveReply":["String","Int"]}}},"aliases":{"Model.Player.Player":{"args":[],"type":"{ bid : Maybe.Maybe String , name : Model.Player.PlayerName , hand : List Model.Card.Card , score : Int }"},"Model.GameState.PlayerTuple":{"args":[],"type":"( Maybe.Maybe Model.Player.Player , Maybe.Maybe Model.Player.Player , Maybe.Maybe Model.Player.Player , Maybe.Maybe Model.Player.Player )"},"Model.GameState.GameId":{"args":[],"type":"Int"},"Model.Trick.ScoredTrick":{"args":[],"type":"( Model.Player.PlayerName, Int, Model.Trick.CompleteTrick )"},"Model.Trick.CompleteTrick":{"args":[],"type":"( Model.Trick.TrickPart , Model.Trick.TrickPart , Model.Trick.TrickPart , Model.Trick.TrickPart )"},"Model.GameState.GameState":{"args":[],"type":"{ id : Model.GameState.GameId , deck : List Model.Card.Card , players : Model.GameState.PlayerTuple , currentTrick : Model.Trick.IncompleteTrick , scoredTricks : List Model.Trick.ScoredTrick , status : Model.Status.Status }"},"Model.Card.Card":{"args":[],"type":"( Model.Card.Rank, Model.Card.Suit )"},"Model.Player.PlayerName":{"args":[],"type":"String"},"Model.Trick.TrickPart":{"args":[],"type":"( Model.Player.PlayerName, Model.Card.Card )"},"Time.Time":{"args":[],"type":"Float"},"Model.Trick.IncompleteTrick":{"args":[],"type":"( Maybe.Maybe Model.Trick.TrickPart , Maybe.Maybe Model.Trick.TrickPart , Maybe.Maybe Model.Trick.TrickPart , Maybe.Maybe Model.Trick.TrickPart )"}},"message":"Model.Msg"},"versions":{"elm":"0.18.0"}});
}
