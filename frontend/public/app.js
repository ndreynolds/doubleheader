...
var _user$project$Channel$pushGameAction = F2(
	function (gameId, action) {
		var topic = A2(
			_elm_lang$core$Basics_ops['++'],
			'game:',
...
var _user$project$Channel$joinLobby = F2(
	function (username, onJoin) {
		return A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
			onJoin,
			A2(
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,
				_user$project$Channel$userParams(username),
				_fbonetti$elm_phoenix_socket$Phoenix_Channel$init('game:lobby')));
	});
var _user$project$Channel$joinGame = F3(
	function (username, onJoin, gameId) {
		return A2(
			_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
			onJoin,
			A2(
...
var _user$project$Model$init = {
	ctor: '_Tuple2',
	_0: {gameState: _elm_lang$core$Maybe$Nothing, socket: _user$project$Model$initSocket, username: '', registered: false, tab: 0, mdl: _debois$elm_mdl$Material$model},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {socket: a, gameState: b, username: c, registered: d, tab: e, mdl: f};
	});
...
var _user$project$View_Game$actionsView = F2(
	function (player, status) {
		...
		var statusText = _elm_lang$core$Basics$toString(status);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			A2(
				...
				A2(_elm_lang$core$List$map, _user$project$View_Game$actionView, actions)));
	});
var _user$project$View_Game$cardBaseView = F3(
...
var _user$project$View_Game$cardFrontView = F2(
	function (attrs, card) {
		var _p8 = card;
		var rank = _p8._0;
		var suit = _p8._1;
			...
			A2(
				...
				A2(
					...
					A2(
						...
						'.png'))));
		return A3(
			_user$project$View_Game$cardBaseView,
			attrs,
			{
				ctor: '::',
...
var _user$project$View_Game$visibleHandView = function (hand) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Game$cardFrontView(
				{ctor: '[]'}),
			hand));
};
var _user$project$View_Game$scoredTrickView = function (_p9) {
	var _p10 = _p9;
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View_Game$visibleHandView(
								{
									ctor: '::',
									_0: _p10._2._0._1,
									_1: {
...
var _user$project$View_Game$scoredTricksView = function (tricks) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$View_Game$scoredTrickView, tricks)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View_Game$activeHandView = function (hand) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$View_Game$currentTrickView = function (_p11) {
	var _p12 = _p11;
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: maybeCardView(
				A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p12._3)),
			_1: {
				ctor: '::',
				_0: maybeCardView(
					A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p12._2)),
				_1: {
					ctor: '::',
					_0: maybeCardView(
						A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p12._1)),
					_1: {
						ctor: '::',
						_0: maybeCardView(
							A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p12._0)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$View_Game$cardBackView = function (attrs) {
	return A2(
		_user$project$View_Game$cardBaseView,
		attrs,
		{
...
var _user$project$View_Game$concealedHandView = function (hand) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Game$cardBackView(
				{ctor: '[]'}),
			hand));
};
var _user$project$View_Game$playerView = F2(
	function (player, username) {
		var _p14 = player;
		if (_p14.ctor === 'Just') {
			var _p16 = _p14._0.name;
			var _p15 = _p14._0.hand;
			var handView_ = _elm_lang$core$Native_Utils.eq(_p16, username) ? _user$project$View_Game$activeHandView(_p15) : _user$project$View_Game$concealedHandView(_p15);
			var scoreText = A2(
				_elm_lang$core$Basics_ops['++'],
				' (',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p14._0.score),
					')'));
			return A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						...
						_0: A2(
							...
							},
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(scoreText),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Empty Seat'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
...
var _user$project$View_Game$tableView = F2(
	function (_p17, username) {
		var _p18 = _p17;
		var _p19 = A2(_user$project$View_Game$arrangePlayers, _p18.players, username);
		var currentPlayer = _p19._0;
		var p1 = _p19._1._0;
		var p2 = _p19._1._1;
		var p3 = _p19._1._2;
		var p4 = _p19._1._3;
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$View_Game$playerView, p2, username),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('table-center'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(_user$project$View_Game$playerView, p1, username),
									_1: {
										ctor: '::',
										_0: _user$project$View_Game$deckView(_p18.deck),
										_1: {
											ctor: '::',
											_0: _user$project$View_Game$currentTrickView(_p18.currentTrick),
											_1: {
												ctor: '::',
												_0: A2(_user$project$View_Game$playerView, p3, username),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('table-bottom'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(_user$project$View_Game$playerView, currentPlayer, username),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$View_Game$actionsView, currentPlayer, _p18.status),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View_Game$gameView = function (model) {
	return A6(
		...
		},
		{
			ctor: '::',
			_0: function () {
				var _p20 = {ctor: '_Tuple2', _0: model.gameState, _1: model.tab};
				_v8_2:
				do {
					if ((_p20.ctor === '_Tuple2') && (_p20._0.ctor === 'Just')) {
						switch (_p20._1) {
							case 0:
								return A2(_user$project$View_Game$tableView, _p20._0._0, model.username);
							case 1:
								return _user$project$View_Game$scoredTricksView(_p20._0._0.scoredTricks);
							default:
								break _v8_2;
						}
					} else {
...
var _user$project$View_Lobby$submitBtn = function (mdl) {
	return A5(
		...
		mdl,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Model$JoinLobby),
					_1: {ctor: '[]'}
				}
			}
		},
...
var _user$project$View_Lobby$usernameField = F2(
	function (mdl, username) {
		return A5(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Textfield$label('Enter a username'),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Textfield$value(username),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Model$SetUsername),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$View_Lobby$lobbyView = function (_p0) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('lobby'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('lobby-inner'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$View_Lobby$usernameField, _p2, _p1.username),
						_1: {
							ctor: '::',
							_0: _user$project$View_Lobby$submitBtn(_p2),
							_1: {
								ctor: '::',
								_0: A3(
									_elm_lang$html$Html$node,
...
var _user$project$View$view = function (model) {
	...
	if (_p0.ctor === 'Just') {
		return _user$project$View_Game$gameView(model);
	} else {
...
var _user$project$Main$subscriptions = function (_p0) {
	var _p1 = _p0;
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, _p1.socket, _user$project$Model$SocketMessage);
};
var _user$project$Main$onNewGameState = function (response) {
	var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Model_GameState$gameStateDecoder, response);
	if (_p2.ctor === 'Ok') {
		return _user$project$Model$NewGameState(_p2._0);
	} else {
		return _user$project$Model$ShowError(_p2._0);
	}
};
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p4.ctor) {
				...
				case 'JoinLobby':
					var channel = A2(_user$project$Channel$joinLobby, model.username, _user$project$Main$onJoinLobby);
				...
				case 'JoinGame':
					...
					var channel = A3(_user$project$Channel$joinGame, model.username, _user$project$Main$onNewGameState, _p8);
					var _p7 = A2(
				...
				case 'Action':
					...
					if (_p9.ctor === 'Just') {
						var _p10 = A2(
							...
							A2(_user$project$Channel$pushGameAction, _p9._0.id, _p4._0),
							model.socket);
						var socket = _p10._0;
						var cmd = _p10._1;
						return {
						...
						var _v5 = _user$project$Model$ShowError('Action fired without an active game'),
							_v6 = model;
						msg = _v5;
						model = _v6;
						continue update;
				...
				default:
					return A3(_debois$elm_mdl$Material$update, _user$project$Model$Mdl, _p4._0, model);
			}
		}
	});
